...
(function () {
    ...
    function addExtractionUI() {
        ...
        button.innerHTML = '<span class="anki-extractor-icon">≡ƒÄ┤</span>Debug Extract';
    ...
    async function handleExtraction() {
        ...
        try {
            ...
            button.innerHTML = '<span class="anki-extractor-icon">ΓÅ│</span>Extracting...';
            ...
            try {
                ...
                console.log('[Anki Extractor] Γ£ô HTML copied to clipboard');
            } catch (clipboardErr) {
            ...
            button.innerHTML = '<span class="anki-extractor-icon">Γ£ô</span>Check Console!';
            ...
            button.innerHTML = '<span class="anki-extractor-icon">Γ£ù</span>Error!';
            ...
            GM_xmlhttpRequest({
                ...
                onload: function (response) {
                    if (response.status === 200) {
                        console.log('[Anki Extractor] Γ£ô Data sent to server successfully');
                ...
                onerror: function (error) {
                    console.error('[Anki Extractor] Γ£ù Failed to send data to server');
                ...
                ontimeout: function () {
                    console.error('[Anki Extractor] Γ£ù Request timed out');
